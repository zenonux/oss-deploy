...
var VersionManager = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [2 /*return*/, []];
                    case 3: return [4 /*yield*/, jsonfile_1.default.readFile(this.jsonPath)];
                    case 4:
                        list = _a.sent();
    ...
    VersionManager.prototype.checkHasVersion = function (prefix) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getJsonFile()];
                    case 1:
                        list = _a.sent();
    ...
    VersionManager.prototype.addVersion = function (prefix) {
        return __awaiter(this, void 0, void 0, function () {
            var isHasVersion, spinner, list, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
