...
var Aod = /** @class */ (function () {
    function Aod(opts) {
        ...
        this.oss = new oss_1.default(this.config.oss, this.config.distPath);
                ...
                switch (_a.label) {
                    ...
                    case 7:
                        ...
                        if (dirList.length >= this.config.maxVersionCountOfMode) {
                            console.warn("Static assets in " + mode + " environment already has " + dirList.length + " versions,please clear unused versions regularly.");
                        }
                        return [2 /*return*/];
                }
            });
