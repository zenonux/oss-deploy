...
var AliOSS = /** @class */ (function () {
    ...
    AliOSS.prototype.sync = function (dir) {
        return __awaiter(this, void 0, void 0, function () {
            var localFiles, remoteFiles, alreadyExitFiles, newFiles;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        files = _a.sent();
                        return [2 /*return*/, files.map(function (val) { return val.basename; })];
                }
            });
        });
    };
    AliOSS.prototype.uploadFiles = function (dir, files) {
        ...
        var e_1, _a;
        return __awaiter(this, void 0, void 0, function () {
            var spinner, file, relativePath, prefixPath, e_2, e_1_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        _b.trys.push([4, 6, , 7]);
                        relativePath = path_1.default.relative(dir, file);
                        prefixPath = this.syncPrefix + "/" + relativePath;
                        return [4 /*yield*/, this.client.put(prefixPath.replace("\\", "/"), file)];
                    case 5:
                        _b.sent();
                        return [3 /*break*/, 7];
                    case 6:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.objects.map(function (val) { return val.name; })];
                }
            });
        });
    };
