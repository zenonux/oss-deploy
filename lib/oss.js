...
var Oss = /** @class */ (function () {
    ...
    Oss.prototype.getTargetFilePath = function (filePath, prefix) {
        return prefix.charAt(prefix.length - 1) === "/"
            ? prefix + filePath
            : prefix + "/" + filePath;
    };
    Oss.prototype.getLocalFilesPath = function (dir) {
    ...
    Oss.prototype.getFilesPathByPrefix = function (prefix) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.objects
                                ? result.objects.map(function (val) { return val.url.split(".com/")[1]; })
                                : []];
                }
            });
        });
    };
    Oss.prototype.sync = function (dir, prefix) {
        return __awaiter(this, void 0, void 0, function () {
            var localFilesPath, remoteFilesPath, alreadyExitFiles, newFiles, answer;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getLocalFilesPath(dir)];
                    case 1:
                        localFilesPath = _a.sent();
                        return [4 /*yield*/, this.getFilesPathByPrefix(prefix)];
                    case 2:
                        remoteFilesPath = _a.sent();
                        alreadyExitFiles = (0, lodash_1.intersectionWith)(localFilesPath, remoteFilesPath, function (localFile, remoteFile) {
                            return _this.getTargetFilePath(localFile, prefix) === remoteFile;
                        });
                        newFiles = (0, lodash_1.difference)(localFilesPath, alreadyExitFiles);
                    ...
                    case 3:
                        answer = _a.sent();
                        if (!answer.release) {
                            log_1.default.warn("\u53D6\u6D88\u4E0A\u4F20\u672C\u5730" + dir + "\u7684\u6587\u4EF6\u81F3oss\u7684" + prefix + "\uFF01");
                            return [2 /*return*/];
                        }
                        if (newFiles.length <= 0) {
                            log_1.default.warn("没有新文件需要上传至oss！");
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, this.uploadFiles(newFiles, dir, prefix)];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Oss.prototype.uploadFiles = function (localFiles, dir, prefix) {
        var localFiles_1, localFiles_1_1;
        var e_1, _a;
        return __awaiter(this, void 0, void 0, function () {
            var file, fullPath, e_2, e_1_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 8, 9, 14]);
                        localFiles_1 = __asyncValues(localFiles);
                        _b.label = 1;
                    case 1: return [4 /*yield*/, localFiles_1.next()];
                    case 2:
                        if (!(localFiles_1_1 = _b.sent(), !localFiles_1_1.done)) return [3 /*break*/, 7];
                        file = localFiles_1_1.value;
                        _b.label = 3;
                    case 3:
                        _b.trys.push([3, 5, , 6]);
                        fullPath = path_1.default.resolve(dir, file);
                        return [4 /*yield*/, this.client.put(this.getTargetFilePath(file, prefix), fullPath)];
                    case 4:
                        _b.sent();
                        log_1.default.success(fullPath + "\u4E0A\u4F20\u6210\u529F");
                        return [3 /*break*/, 6];
                    case 5:
                        e_2 = _b.sent();
                        throw new Error(e_2);
                    ...
                    case 9:
                        ...
                        if (!(localFiles_1_1 && !localFiles_1_1.done && (_a = localFiles_1.return))) return [3 /*break*/, 11];
                        return [4 /*yield*/, _a.call(localFiles_1)];
                    case 10:
                        _b.sent();
                        _b.label = 11;
    ...
    Oss.prototype.uploadAssets = function (prefix) {
        var e_3, _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    Oss.prototype.handleDel = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            var error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Oss.prototype.deleteAssets = function (prefix) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Oss.prototype.clearAllUnNeedAssests = function (dirList) {
